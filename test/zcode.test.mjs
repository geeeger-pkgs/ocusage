...
import { getDailyStats, getDateRangeStats } from "../providers/zcode.mjs";
import { createFileTestDB, seedTypicalDay } from "./fixtures/helpers.mjs";

setLocale("zh-CN");

describe("ZCode getDailyStats", () => {
  let db;
  let dbPath;
  let cleanup;
  ...
  it("returns null for non-existent path", () => {
    db.close();
    const result = getDailyStats("/nonexistent/path/zcode.db", "2025-04-20");
...
describe("ZCode getDateRangeStats", () => {
  let db;
  let dbPath;
  let cleanup;
